    ...
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <section className="set-sec">
          ...
          <p className="modal__small">
            {offlineReady
              ? "準備済み ✓ 圏外(山奥など)でも道路網・水域・地名(町丁目)・道路番号・駅・神社仏閣・施設(給油/道の駅/役所/山/ダム/温泉/コンビニ等)・現在地・ルートが表示されます。"
              : "山奥など電波が切れる場所の対策です。Wi-Fi接続時に一度ダウンロードしておくと、圏外でも道路網・地名(町丁目)・道路番号・駅・神社仏閣・施設(給油/道の駅/役所/山/ダム/温泉/コンビニ等)・現在地・ルートが表示されます（約160MB）。"}
